...
void Staff::input(void) {
	...
	cout << "Salary    :";	cin >> salary; setSalary(salary);
...
void writeToFile(ostream& out, Staff & theObject) {
	out << setw(5) << theObject.m_id << left
		<< "," << setw(20) << theObject.m_name
		<< "," << setw(2)  << theObject.m_age
		<< "," << setw(5)  << theObject.m_address.getBuildingNumber()
		<< "," << setw(20) << theObject.m_address.getStreetName()
		<< "," << setw(10) << theObject.m_address.getCityName()
		<< "," << setw(2)  << theObject.m_address.getStateName()
		<< "," << setw(5)  << theObject.m_address.getZipCode()
		<< "," << setw(15) << theObject.m_role
		<< "," << setw(10) << fixed << setprecision(2) << theObject.m_salary
		<< endl;
}
